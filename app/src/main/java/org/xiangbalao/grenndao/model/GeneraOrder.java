 ...
 */
@Entity
public class GeneraOrder extends BaseModel {
    ...
    @Generated(hash = 542847051)
    public GeneraOrder(Long id, String receiptType, String receiptId,
            int printCount, int isoffline, String op, Date rDate, Date rTime,
            String antiFakeCode, double discount, double aTotal, double total,
            double tax, double cash, double change, String ejsn, Date ejActiDate,
            int payWay, double payAmount, Long taxPayerId, int currency,
            Date createdTime, String creatorId) {
        this.id = id;
