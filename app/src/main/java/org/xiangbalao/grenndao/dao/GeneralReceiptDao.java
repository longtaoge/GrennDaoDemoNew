...
/** 
 * DAO for table "GENERAL_RECEIPT".
*/
public class GeneralReceiptDao extends AbstractDao<GeneraOrder, Long> {

    public static final String TABLENAME = "GENERAL_RECEIPT";

    /**
     * Properties of entity GeneralReceipt.<br/>
    ...
    public GeneralReceiptDao(DaoConfig config) {
        super(config);
    }
    
    public GeneralReceiptDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GENERAL_RECEIPT\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GENERAL_RECEIPT\"";
        db.execSQL(sql);
    }
